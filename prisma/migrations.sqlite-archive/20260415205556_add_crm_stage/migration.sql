...
INSERT INTO "new_Project" ("categoryTag", "companyId", "createdAt", "description", "dueDate", "id", "mrr", "name", "onboarded", "ownerId", "priority", "progress", "serviceType", "stage", "teamId", "updatedAt") SELECT "categoryTag", "companyId", "createdAt", "description", "dueDate", "id", "mrr", "name", "onboarded", "ownerId", "priority", "progress", "serviceType", "stage", "teamId", "updatedAt" FROM "Project";
DROP TABLE "Project";
