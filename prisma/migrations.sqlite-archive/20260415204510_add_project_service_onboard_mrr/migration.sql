...
INSERT INTO "new_Project" ("categoryTag", "companyId", "createdAt", "description", "dueDate", "id", "name", "ownerId", "priority", "progress", "stage", "teamId", "updatedAt") SELECT "categoryTag", "companyId", "createdAt", "description", "dueDate", "id", "name", "ownerId", "priority", "progress", "stage", "teamId", "updatedAt" FROM "Project";
DROP TABLE "Project";
